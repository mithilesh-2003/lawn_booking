...
function Home() {
  ...
  return (
    <>
     <div className="flex justify-center items-center mt-24 bg-white shadow-lg">
          <img
        ...
        <div className=" flex gap-7 justify-between ml-20 mr-20 mt-40 pb-10  grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
